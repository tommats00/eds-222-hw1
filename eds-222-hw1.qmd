...
There are 5488 pollution records in the crowdsourced data set.
There are 1960 pollution records in govt data set. 
...
unique(govt_id$id)
```
There are 14 unique monitors in the crowd sourced data set. 
There are 5 unique monitors in the govt data set. 
::: callout-tip
